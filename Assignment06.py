...
#   Alex Kover, 5/21/24, Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class FileProcessor:
    ...
    Alex Kover, 5/21/24, Created Class
    """

    @staticmethod
    def read_data_from_file(file_name: str, student_data: list):
        """ This function reads data from a json file and adds it to a list of dictionaries

                ChangeLog: (Who, When, What)
                Alex Kover, 5/21/24, Created Function
    ...
    def write_data_to_file(file_name: str, student_data: list):
        """ This function writes data to a json file using a list of dictionaries
